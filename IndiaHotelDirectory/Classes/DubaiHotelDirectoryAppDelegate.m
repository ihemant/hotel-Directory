...
#import "DubaiHotelDirectoryAppDelegate.h"
#import "MapViewController.h"
#import "HotelDetail.h"

@implementation DubaiHotelDirectoryAppDelegate
@synthesize window;
@synthesize tabBarController;
@synthesize navigationController;
@synthesize viewController;
@synthesize hotelDetail;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
	...
	[self createEditableCopyDatabaseIfNeeded];
...
-(void)createEditableCopyDatabaseIfNeeded{
	...
	NSString *writableDBpath = [documentsDirectory stringByAppendingPathComponent:@"HotelList.sqlite"];
	BOOL dbexists = [fileManager fileExistsAtPath:writableDBpath];
	if(!dbexists){
		NSString *defaultDBPath = [[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"HotelList.sqlite"];
		NSError *error ;
