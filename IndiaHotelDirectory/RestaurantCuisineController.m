...
#import "RestaurantCuisineController.h"
...
@implementation RestaurantCuisineController

@synthesize mainTableView;
@synthesize contentsList, contentsList1;
@synthesize searchResults;
@synthesize savedSearchTerm;
@synthesize managedObjectContext,fetchedResultsController, dataArray, dataArray1, searchBy,selectedRestaurantCuisine;
...
- (NSFetchedResultsController *)fetchedResultsController {
	...
	if ([selectedRestaurantCuisine isEqualToString:@"MultiCuisine"]) {
		predicate = [NSPredicate predicateWithFormat: @"(cuisineName == 'MultiCuisine')"];
		
		}
	else if([selectedRestaurantCuisine isEqualToString:@"Arabic"]) {
		predicate = [NSPredicate predicateWithFormat: @"(cuisineName == 'Arabic')"];
		
	}
	else if([selectedRestaurantCuisine isEqualToString:@"Chinese"]) {
		predicate = [NSPredicate predicateWithFormat: @"(cuisineName == 'Chinese')"];
		
	}
	else if([selectedRestaurantCuisine isEqualToString:@"Indian"]) {
		predicate = [NSPredicate predicateWithFormat: @"(cuisineName == 'Indian')"];
		
	}
	else if([selectedRestaurantCuisine isEqualToString:@"Thai"]) {
		predicate = [NSPredicate predicateWithFormat: @"(cuisineName == 'Thai')"];
		
	}
	else if([selectedRestaurantCuisine isEqualToString:@"Italian"]) {
		predicate = [NSPredicate predicateWithFormat: @"(cuisineName == 'Italian')"];
		
	}
		
	else {
		[selectedRestaurantCuisine isEqualToString:@"Japanese"]; 
		predicate = [NSPredicate predicateWithFormat: @"(cuisineName == 'Japanese')"];
