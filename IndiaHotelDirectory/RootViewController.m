...
@synthesize managedObjectContext,fetchedResultsController,ratingArray,selectedRestaurantCuisine;
...
- (void)viewDidLoad {
	...
	types = [[NSArray alloc] initWithObjects:@"MultiCuisine", @"Arabic", @"Chinese", @"Chinese",@"Thai",@"Italian",@"Japanese", nil];
	[self setTitle:@"Cuisine"];
	NSError *error;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	NSLog(@"\nCHecking...");
	RestaurantCuisineController *hotelController = [[RestaurantCuisineController alloc] initWithNibName:@"RestaurantCuisineController" bundle:nil];
	hotelController.selectedRestaurantCuisine = [types objectAtIndex:[indexPath row]];
...
- (NSFetchedResultsController *)fetchedResultsController {
	...
	NSPredicate *predicate= [NSPredicate predicateWithFormat: @"(cuisineName == %@)",selectedRestaurantCuisine];
	...
	if([array count]>0){
		...
		while ((obj = [e nextObject]) != nil) {
			...
			if([[obj valueForKey:@"cuisineName"] length]== 1){
				[ratingArray addObject:[obj valueForKey:@"cuisineName"]];	
			}
			
			//NSLog(@"rating --> %@",[obj valueForKey:@"rating"]);
